...
$row=$resultado->fetch_assoc();
    ...
    <input type="text" REQUIRED pattern="{1,10}" name="nombre" placeholder="Nombre..." value="<?php echo $row['nombre'];?>"  class="input-50">
      ...
      <input type="text" REQUIRED pattern="{1,30}" name="unidad" placeholder="Unidad..." value="<?php echo $row['unidad'];?>"  class="input-50">
        <input type="text" REQUIRED pattern="[0-9_-]{1,10}" name="limite" placeholder="Minimo Producto..." value="<?php echo $row['limite_m'];?>"  class="input-50">
