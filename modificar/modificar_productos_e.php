...
<?php
$id_compra_e=$_REQUEST['id_compra_e'];
include("conexion.php");
$query="SELECT * FROM productos_e WHERE id_compra_e='$id_compra_e'";
...
$row=$resultado3->fetch_assoc();
  ?>
	...
	<form  action="upd_compra_e.php?id_compra=<?php echo $row['id_compra_e'];?>" method="POST"  class="form-register" >
  ...
  <div class="contenedor-inputs">
   ...
   <input type="text" REQUIRED pattern="{1,10}" name="vale" placeholder="# Vale..." value="<?php echo $row['vale'];?>"  class="input-50">
      ...
      <input type="number" REQUIRED pattern="[0-9_-]{1,10}" name="abono" placeholder="Abono..." value="<?php echo $row['abono_d'];?>"  class="input-50">
      <input type="number" REQUIRED pattern="[0-9_-]{1,10}" name="tc" placeholder="TC..." value="<?php echo $row['tc'];?>"  class="input-50">
