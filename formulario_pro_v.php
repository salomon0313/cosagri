...
$row=$resultado3->fetch_assoc();
  ?>
	...
	<form  action="guardar_g_v.php?n_serie=<?php echo $row['n_serie'];?>" method="POST"  class="form-register" >
...
<option value="Correctivo"> Correctivo </option>
      ...
      <input type="text" REQUIRED pattern="{1,100}" name="descripcion" placeholder="Descripcion..." value=""  class="input-100">
          <input type="text" REQUIRED pattern="[0-9_-]{1,15}" name="Costo" placeholder="Costo..." value=""  class="input-50">
