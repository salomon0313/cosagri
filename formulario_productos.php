...
$row=$resultado3->fetch_assoc();
  ?>
	...
	<form  action="guardar_productos.php?id_proveedor=<?php echo $row['id_proveedor'];?>" method="POST"  class="form-register" >
	...
	<div class="contenedor-inputs">
	 ...
	 <input type="text" REQUIRED pattern="{1,10}" name="vale" placeholder="# Vale..." value=""  class="input-50">
      ...
      <input type="text" REQUIRED pattern="[0-9_-]{1,10}" name="abono" placeholder="Abono..." value=""  class="input-50">
